...
due to its single-threaded architecture. The benchmark program is been run from another
...
1. SETs (`--ratio 1:0`): Redis 159K, P99.9 - 1.16ms, P99 - 0.82ms  | DF - 173K, P99.9 - 1.26ms, P99 - 0.9ms
2. GETs (`--ratio 0:1`): Redis 194K, P99.9 - 0.8ms, P99 - 0.65ms   | DF - 191K, P99.9 - 0.95ms, P99 - 0.8ms
...
1. SETs (`--ratio 1:0`): Redis 190K, P99.9 - 2.45ms, P99 - 0.97ms | DF - 279K , P99.9 - 1.95ms, P99 - 1.48
2. GETs (`--ratio 0:1`): Redis 220K, P99.9 - 0.98ms , P99 - 0.8ms  | DF -305K , P99.9 - 1.03ms, P99 - 0.87ms
